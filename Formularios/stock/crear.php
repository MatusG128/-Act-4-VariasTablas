                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="<?php echo base_url; ?>CRUDM/insertarDatos.php" method="POST">
                            <div class="mb-3">
                                <label for="nombreM" class="form-label">Cantidad</label>
                                <input type="text" class="form-control" id="cantidad" name="cantidad" placeholder="Cantidad" required>
                            </div>
                            <div class="mb-3">
                                <label for="estadoM" class="form-label">Medida</label>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="maximos" name="maximos" placeholder="Stock maximo" required>
                            </div>
                            <div class="mb-3">
                                <label for="minimos" class="form-label">Minimos</label>
                                <input type="text" class="form-control" id="minimos" name="minimos" placeholder="Stock minimo" required>
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="nombreA" name="nombreA" placeholder="Nombre articulo" required>
                            </div>
