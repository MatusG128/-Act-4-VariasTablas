                    ...
                    <div class="card-body">
                        ...
                        <form action="<?php echo base_url; ?>CRUDC/insertarDatos.php" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="email" class="form-control" id="email" name="email" placeholder="Email del proveedor" required>
                            </div>
                            <div class="mb-3">
                                <label for="telefono" class="form-label">Telefono</label>
                                <input type="text" class="form-control" id="telefono" name="telefono" placeholder="Telefono del proveedor" required>
                            </div>
                            <div class="mb-3">
                                <label for="termino" class="form-label">Termino de Pago</label>
                                <input type="text" class="form-control" id="termino" name="termino" placeholder="Termino" required>
                            </div>
